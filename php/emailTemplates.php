                                        ...
                                        <tr>
                                            <td align="center">
                                                <table width="360 " border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td width="120" align="center" style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;"> <a href="" style="color: #312c32; text-decoration: none;">Desarrollo Web</a> </td>
                                                        <td width="120" align="center" style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;"> <a href=""     style="color: #312c32; text-decoration: none;">Arquitectura</a> </td>
                                                        <td width="120" align="center"
                                                            style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                            <a href="" style="color: #312c32; text-decoration: none;">Cocina</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table border="0" width="590" align="center" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <p style="line-height: 24px;margin-bottom:15px;">
                                                    Te damos la bienvenida a SnSanFrancisco, es muy importante para nosotros tu
                                                    seguridad, por ello es necesario que hagas verificación de tu correo.
                                                </p>
                                                <p style="line-height: 24px; margin-bottom:20px;">
                                                    Has click en el siguiente enlace para que puedas acceder y continuar con el
