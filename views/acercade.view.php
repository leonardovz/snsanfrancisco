    ...
    <main>
        <div class="container">
            ...
            <section class="mt-5 wow fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <p>Da a conoer tu negocio y lo que sabes hacer de una manera distinta.</p>
                        <!-- Main heading -->

                        <hr>

                        <p>
                            <strong>80%+</strong> de las personas que necesitan algo, primero lo buscan en su celular,
                            el otro <strong>20%</strong> recomiendan, negocios o servicios con conocidos <br>
            ...
            <section>
                ...
                <h3 class="h3 text-center mb-5">Sobre SnSanfrancisco</h3>
            ...
            <section>
                ...
                <h2 class="my-5 h3 text-center">¿Aún no estas convencido? </h2>
                ...
                <div class="row features-small mb-5 mt-3 wow fadeIn">
                    ...
                    <div class="col-md-4 mt-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h6 class="feature-title">Muestrales tu dirección para que puedan contactarte de manera más directa</h6>
            ...
            <section>
                ...
                <h2 class="my-5 h3 text-center">Y... algunas de las tecnologias utilizadas</h2>
